...
System.out.println(word);
 ...
 String aa=bs.toString();
    ...
    else
    {
		...
		String vo="findinga finding";
	System.out.println(vo);
	int v=0;
	int cs=0;
		for(int i=0;i<vo.length();i++)
		{
			if(vo.charAt(i)=='a'|| vo.charAt(i)=='e'|| vo.charAt(i)=='i'
				||	vo.charAt(i)=='O'|| vo.charAt(i)=='u')
			{
          v++;
	...
	for(c ='a';c<='z';c++)
	{
		...
		System.out.println("duplicate characters are  "+c+ "= "+count);		
	}	
